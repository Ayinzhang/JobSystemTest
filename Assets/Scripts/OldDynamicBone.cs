...
public class OldDynamicBone : MonoBehaviour
{
    ...
    static List<OldDynamicBone> s_PendingWorks = new List<OldDynamicBone>();
    static List<OldDynamicBone> s_EffectiveWorks = new List<OldDynamicBone>();
...
#if ENABLE_MULTITHREAD
    static void AddPendingWork(OldDynamicBone db)
    {
        s_PendingWorks.Add(db);
    }

    static void AddWorkToQueue(OldDynamicBone db)
    {
        s_WorkQueueSemaphore.Release();
    }

    static OldDynamicBone GetWorkFromQueue()
    {
    ...
    static void ThreadProc()
    {
        while (true)
        {
            ...
            OldDynamicBone db = GetWorkFromQueue();
            db.UpdateParticles();
    ...
    static void ExecuteWorks()
    {
        ...
        {
            OldDynamicBone db = s_PendingWorks[i];
        ...
        {
            OldDynamicBone db = s_EffectiveWorks[i];
            db.Prepare();
            AddWorkToQueue(db);
        }
