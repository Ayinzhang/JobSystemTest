...
public class NewDynamicBone : MonoBehaviour
{
    ...
    static List<NewDynamicBone> s_PendingWorks = new List<NewDynamicBone>();
    static List<NewDynamicBone> s_EffectiveWorks = new List<NewDynamicBone>();
...
#if ENABLE_MULTITHREAD
    static void AddPendingWork(NewDynamicBone db)
    {
        s_PendingWorks.Add(db);
    }

    static void AddWorkToQueue(NewDynamicBone db)
    {
        s_WorkQueueSemaphore.Release();
    }

    static NewDynamicBone GetWorkFromQueue()
    {
    ...
    static void ThreadProc()
    {
        while (true)
        {
            ...
            NewDynamicBone db = GetWorkFromQueue();
            db.UpdateParticles();
    ...
    static void ExecuteWorks()
    {
        ...
        {
            NewDynamicBone db = s_PendingWorks[i];
        ...
        {
            NewDynamicBone db = s_EffectiveWorks[i];
            db.Prepare();
            AddWorkToQueue(db);
        }
